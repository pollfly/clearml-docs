...
Enterprise Server 3.26.0 is not fully compatible with earlier versions of the Application Gateway. It is recommended to 
update the gateway components when upgrading the server.

Recommended Application Gateway Versions:
* Containers:
